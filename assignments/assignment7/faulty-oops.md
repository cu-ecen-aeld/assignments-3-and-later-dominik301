...
# Output of objdump
after adding EXTRA_CFLAGS += -g to misc-modules Makefile (enabling debug information),
execute write to /dev/faulty:
```
...
Data abort info:
  ...
  CM = 0, WnR = 1
user pgtable: 4k pages, 39-bit VAs, pgdp=0000000041c12000
...
sp : ffffffc008dd3d20
x29: ffffffc008dd3d80 x28: ffffff8001b9b500 x27: 0000000000000000
x26: 0000000000000000 x25: 0000000000000000 x24: 0000000000000000
x23: 000000000000000c x22: 000000000000000c x21: ffffffc008dd3dc0
x20: 00000055631aa990 x19: ffffff8001be6100 x18: 0000000000000000
...
null pointer dereference 10 bytes into faulty_write (corresponds to line 53 *(int *)0 = 0; in faulty.c)

using: 
./buildroot/output/host/bin/aarch64-linux-objdump -S ./buildroot/output/target/lib64/modules/6.1.44/extra/faulty.ko 

```
./buildroot/output/target/lib64/modules/6.1.44/extra/faulty.ko:     file format elf64-littleaarch64
...
0: x1 is set to NULL pointer
10: attempt to dereference NULL pointer